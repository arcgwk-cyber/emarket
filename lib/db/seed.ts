...
async function seed() {
  ...
  try {
    ...
    const subCategoriesData = [
      { name: 'Curries', slug: 'curries', description: 'Delicious hot curries', parentName: 'Cloud Kitchen', imageUrl: 'https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=300&auto=format&fit=crop&q=60' },
      { name: 'Salads', slug: 'salads', description: 'Fresh fitness salads', parentName: 'Cloud Kitchen', imageUrl: 'https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=300&auto=format&fit=crop&q=60' },
      { name: 'Desserts', slug: 'desserts', description: 'Healthy and classic desserts', parentName: 'Cloud Kitchen', imageUrl: 'https://images.unsplash.com/photo-1551024506-0bccd828d307?w=300&auto=format&fit=crop&q=60' },
      { name: 'Special Diet', slug: 'special-diet', description: 'Targeted fitness and medical meals', parentName: 'Cloud Kitchen', imageUrl: 'https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=300&auto=format&fit=crop&q=60' },
    ];

    for (const sub of subCategoriesData) {
      const parentId = insertedCategories[sub.parentName];
      const existing = await db.query.categories.findFirst({
        where: (c, { and, eq }) => and(eq(c.businessId, businessId), eq(c.slug, sub.slug)),
      });
      ...
      if (!existing) {
        ...
        insertedCategories[sub.name] = res.id;
      } else {
        insertedCategories[sub.name] = existing.id;
      }
    }
    ...
    const productsData = [
      ...
      },
      {
        ...
        images: ['https://images.unsplash.com/photo-1565557623262-b51c2513a641?w=400&auto=format&fit=crop&q=60'],
        mrp: '280.00',
        sellingPrice: '250.00',
        costPrice: '120.00',
        stockType: 'pack',
      ...
      {
        name: 'Veg Paneer Butter Masala',
        slug: 'veg-paneer-butter-masala',
        sku: 'KIT-PBM-001',
        categoryName: 'Curries',
        brandName: 'E-Market Kitchen',
        description: 'Cottage cheese cubes cooked in a rich, creamy, and mildly sweet tomato-based gravy.',
        shortDescription: 'Creamy paneer butter masala curry.',
        images: ['https://images.unsplash.com/photo-1631452180519-c014fe946bc7?w=400&auto=format&fit=crop&q=60'],
        mrp: '240.00',
        sellingPrice: '210.00',
        costPrice: '100.00',
        stockType: 'pack',
      ...
      },
      {
        ...
        slug: 'high-protein-chickpea-salad',
        sku: 'KIT-HCS-001',
        categoryName: 'Salads',
        brandName: 'E-Market Kitchen',
        description: 'Boiled chickpeas tossed with cucumbers, onions, tomatoes, coriander, lemon dressing, and olive oil.',
        shortDescription: 'Clean high protein veg salad.',
        images: ['https://images.unsplash.com/photo-1540189549336-e6e99c3679fe?w=400&auto=format&fit=crop&q=60'],
        mrp: '180.00',
        sellingPrice: '150.00',
        costPrice: '60.00',
        stockType: 'pack',
        ...
        isFeatured: true,
        dietType: 'veg',
        dietaryPreferences: ['Weight Loss', 'Diabetic', 'Pre-workout'],
      },
      {
        ...
        categoryName: 'Salads',
        brandName: 'E-Market Kitchen',
        description: 'Grilled chicken breast strips, fresh lettuce, cucumbers, cherry tomatoes, and extra virgin olive oil dressing.',
        shortDescription: 'Low carb healthy keto salad.',
        images: ['https://images.unsplash.com/photo-1546069901-ba9599a7e63c?w=400&auto=format&fit=crop&q=60'],
        mrp: '220.00',
        sellingPrice: '190.00',
        costPrice: '90.00',
        stockType: 'pack',
      ...
      },
      {
        ...
        slug: 'sugar-free-chia-seed-pudding',
        sku: 'KIT-CSP-001',
        categoryName: 'Desserts',
        brandName: 'E-Market Kitchen',
        description: 'Chia seeds soaked in almond milk, sweetened with stevia, and topped with fresh blueberries.',
        shortDescription: 'Sugar-free almond milk chia pudding.',
        images: ['https://images.unsplash.com/photo-1488477181946-6428a0291777?w=400&auto=format&fit=crop&q=60'],
        mrp: '150.00',
        sellingPrice: '130.00',
        costPrice: '50.00',
        stockType: 'pack',
        ...
        isFeatured: false,
        dietType: 'veg',
        dietaryPreferences: ['Weight Loss', 'Diabetic'],
      },
      {
        name: 'Protein Chocolate Mousse',
        slug: 'protein-chocolate-mousse',
        sku: 'KIT-PCM-001',
        categoryName: 'Desserts',
        brandName: 'E-Market Kitchen',
        description: 'Creamy dark chocolate mousse whipped with whey protein isolate and stevia.',
        shortDescription: 'Low-calorie protein chocolate mousse.',
        images: ['https://images.unsplash.com/photo-1541795795328-f073b763494e?w=400&auto=format&fit=crop&q=60'],
        mrp: '170.00',
        sellingPrice: '145.00',
        costPrice: '65.00',
        stockType: 'pack',
        ...
        isFeatured: false,
        dietType: 'veg',
        dietaryPreferences: ['Bulking', 'Post-workout'],
      },
      {
        name: 'Keto Chicken Broccoli Bowl',
        slug: 'keto-chicken-broccoli-bowl',
        sku: 'KIT-CBB-001',
        categoryName: 'Special Diet',
        brandName: 'E-Market Kitchen',
        description: 'Tender chicken cubes stir-fried with broccoli florets in garlic butter sauce.',
        shortDescription: 'High fat, high protein keto friendly bowl.',
        images: ['https://images.unsplash.com/photo-1512621776951-a57141f2eefd?w=400&auto=format&fit=crop&q=60'],
        mrp: '260.00',
        sellingPrice: '230.00',
        costPrice: '110.00',
        stockType: 'pack',
      ...
      },
      {
        ...
        categoryName: 'Special Diet',
        brandName: 'E-Market Kitchen',
        description: 'Organic quinoa, steamed edamame, roasted sweet potatoes, avocado slices, and tahini dressing.',
        shortDescription: 'Nutrient-dense vegan power bowl.',
        images: ['https://images.unsplash.com/photo-1540420773420-3366772f4999?w=400&auto=format&fit=crop&q=60'],
        mrp: '230.00',
        sellingPrice: '199.00',
        costPrice: '90.00',
        stockType: 'pack',
        ...
        isFeatured: true,
        dietType: 'veg',
        dietaryPreferences: ['Weight Loss', 'Pre-workout', 'Diabetic'],
      }
    ];
